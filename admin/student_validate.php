<?php
// admin/student_validate.php
// Sets a student's overall assessment status to "validated"
...
header('Location: student_profile.php?user_id=' . $student_id . '&msg=validated');
exit;
