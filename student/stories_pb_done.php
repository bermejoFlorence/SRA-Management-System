...
while ($p = $pr->fetch_assoc()) {
  // guarantee percent using totals if needed
      ...
      <div class="list">
        <?php foreach ($prev as $p): ?>
          <div class="prev-card">
            ...
            <div>
              <a class="btn-ghost" href="stories_pb_done.php?attempt_id=<?= (int)$p['attempt_id'] ?>">View</a>
            </div>
          </div>
        <?php endforeach; ?>
      </div>
